...
This issue tracker is only for technical issues related to Modden Core.
General Modden questions and/or support requests and are best directed to the [Modden Discord](https://discord.gg/axyt3aMMAd).
...
### What version of Modden Core are you using?
