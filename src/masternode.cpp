...
CAmount CMasternode::GetMasternodeNodeCollateral(int nHeight) 
{
    ...
    if (nHeight >  1500000) return     300000 * COIN;
    if (nHeight >  1460000) return     290000 * COIN;
    if (nHeight >  1420000) return     280000 * COIN;
    if (nHeight >  1380000) return     270000 * COIN;
    if (nHeight >  1340000) return     260000 * COIN;
    if (nHeight >  1300000) return     240000 * COIN;
    if (nHeight >  1260000) return     220000 * COIN;
    if (nHeight >  1220000) return     200000 * COIN;
    if (nHeight >  1180000) return     180000 * COIN;
    if (nHeight >  1140000) return     160000 * COIN;
    if (nHeight >  1100000) return     150000 * COIN;
    if (nHeight >  1060000) return     140000 * COIN;
    if (nHeight >  1020000) return     130000 * COIN;
    if (nHeight >  980000) return      120000 * COIN;
    if (nHeight >  940000) return      115000 * COIN;
    if (nHeight >  900000) return      110000 * COIN;
    if (nHeight >  860000) return      105000 * COIN;
    if (nHeight >  820000) return      100000 * COIN;
    if (nHeight >  780000) return      95000 * COIN;
    if (nHeight >  740000) return      90000 * COIN;
    if (nHeight >  700000) return      85000 * COIN;
    if (nHeight >  660000) return      80000 * COIN;
    if (nHeight >  620000) return      75000 * COIN;
    if (nHeight >  580000) return      70000 * COIN;
    if (nHeight >  540000) return      65000 * COIN;
    if (nHeight >  500000) return      60000 * COIN;
    if (nHeight >  460000) return      55000 * COIN;
    if (nHeight >  420000) return      50000 * COIN;
    if (nHeight >  380000) return      45000 * COIN;
    if (nHeight >  340000) return      40000 * COIN;
    if (nHeight >  300000) return      36000 * COIN;
    if (nHeight >  260000) return      32000 * COIN;
    if (nHeight >  220000) return      28000 * COIN;
    if (nHeight >  180000) return      24000 * COIN;
...
CAmount CMasternode::GetBlockValue(int nHeight)
{
    ...
    else if (nHeight <= 1180000) { 
        nSubsidy = 190 * COIN;
    }
    else if (nHeight <= 1220000) { 
        nSubsidy = 192 * COIN;
    }
    ...
    else if (nHeight <= 1340000) { 
        nSubsidy = 192 * COIN;
    }
    else if (nHeight <= 1380000) { 
        nSubsidy = 94 * COIN;
    }
    else if (nHeight >= 1420000) { 
        nSubsidy = 96 * COIN;
    }
    else if (nHeight <= 1460000) { 
        nSubsidy = 94 * COIN;
    }
...
bool CMasternodeBroadcast::CheckInputsAndAdd(int& nDoS)
{
    ...
    // should be at least not earlier than block when 1000 Modden tx got MASTERNODE_MIN_CONFIRMATIONS
    uint256 hashBlock = UINT256_ZERO;
    CTransaction tx2;
    GetTransaction(vin.prevout.hash, tx2, hashBlock, true);
    BlockMap::iterator mi = mapBlockIndex.find(hashBlock);
    if (mi != mapBlockIndex.end() && (*mi).second) {
        CBlockIndex* pMNIndex = (*mi).second;                                   // block for 1000 Modden tx -> 1 confirmation
