...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        {"modden", "reloadmasternodeconfig", &reloadmasternodeconfig, true },
        ...
        {"modden", "getactivemasternodecount", &getactivemasternodecount, true },
        ...
        {"modden", "mnping", &mnping, true },
        {"modden", "getcollateral", &getcollateral, true},
