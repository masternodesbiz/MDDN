...
#define PACKAGE_BUGREPORT "https://ModdenBF/modden/issues"

/* Define to the full name of this package. */
#define PACKAGE_NAME "Modden Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Modden Core 5.0.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "modden"

/* Define to the home page for this package. */
#define PACKAGE_URL "https://modden.io"
