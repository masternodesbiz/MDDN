...
class ReorgStakeTest(PivxTestFramework):
    ...
    def check_money_supply(self, expected_piv):
        ...
        # verify that nodes have the expected Modden supply
        for node in g_info:
    ...
    def run_test(self):
        ...
        # Check Modden supply at the beginning
        # ------------------------------------------
        # Modden supply: block rewards minus burned fees for minting
        ...
        # Verify that Modden supplies were properly updated after the spends and reorgs
        self.log.info("Check Modden supply...")
