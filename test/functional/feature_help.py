...
"""Verify that starting modden with -h works as expected."""
import subprocess
...
class HelpTest(PivxTestFramework):
    ...
    def run_test(self):
        self.log.info("Start modden with -? for help text")
        ...
        self.log.info("Start modden with -version for version information")
